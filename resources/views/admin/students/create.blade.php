...
@section('page_title', 'Tambah Student Baru')
@section('page_subtitle', 'Masukkan data identitas dan akun santri baru.')
...
<div class="max-w-2xl bg-white rounded-3xl border border-slate-200 p-8 shadow-sm space-y-6">
    <form action="{{ route('admin.students.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <textarea name="notes" rows="2" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs focus:border-primary-600 outline-none"></textarea>
        </div>
