...
<section class="relative overflow-hidden bg-islamic-pattern text-white py-24 lg:py-32 border-b-4 border-gold-500/80">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center mb-8">
            <div class="inline-block text-2xl sm:text-3xl font-quran text-gold-400/90 tracking-wider">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div class="lg:col-span-7 space-y-6 text-center lg:text-left">
                <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-950/80 border border-gold-500/30 text-xs text-gold-400 font-semibold uppercase tracking-widest backdrop-blur shadow-inner">
                    <span class="text-gold-400 text-sm">✦</span> {{ $settings['hero_badge'] }} <span class="text-gold-400 text-sm">✦</span>
                </div>
                
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.18] text-white">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-4 pt-4 justify-center lg:justify-start">
                    <a href="{{ route('assessment') }}" class="w-full sm:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-gold-400 via-amber-500 to-gold-500 hover:from-gold-300 hover:to-amber-400 text-slate-950 font-extrabold text-sm shadow-xl shadow-amber-900/40 hover:shadow-2xl hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 border border-gold-300/40">
                        <i data-lucide="compass" class="w-4 h-4 text-slate-950"></i> Mulai Placement Test Mandiri
                    </a>
                    <a href="{{ route('programs') }}" class="w-full sm:w-auto px-8 py-4 rounded-2xl bg-emerald-950/60 hover:bg-emerald-900/80 border border-emerald-500/30 text-white font-semibold text-sm backdrop-blur transition-all flex items-center justify-center gap-2">
                        <i data-lucide="book-open" class="w-4 h-4 text-gold-400"></i> Katalog Program & Silabus
                    </a>
                </div>

                <!-- 3 Pillars Mini Info -->
                <div class="pt-8 grid grid-cols-3 gap-4 border-t border-emerald-800/60 text-left">
                    <div class="p-3 rounded-2xl bg-emerald-950/40 border border-emerald-800/40">
                        <div class="text-xl font-bold text-gold-400 font-serif">1-on-1</div>
                        <div class="text-[11px] text-emerald-200">Talaqqi Privat</div>
                    </div>
                    <div class="p-3 rounded-2xl bg-emerald-950/40 border border-emerald-800/40">
                        <div class="text-xl font-bold text-gold-400 font-serif">Bersanad</div>
                        <div class="text-[11px] text-emerald-200">Riwayat Hafsh</div>
                    </div>
                    <div class="p-3 rounded-2xl bg-emerald-950/40 border border-emerald-800/40">
                        <div class="text-xl font-bold text-gold-400 font-serif">Terukur</div>
                        <div class="text-[11px] text-emerald-200">Progress Report</div>
                    </div>
                </div>
            </div>

            <!-- Right Visual Card (Islamic Arch Ornament) -->
            <div class="lg:col-span-5 relative">
                <div class="bg-gradient-to-b from-emerald-950/90 to-slate-950/95 border-2 border-gold-500/30 backdrop-blur-2xl rounded-3xl p-6 sm:p-8 shadow-2xl text-white space-y-6 relative overflow-hidden">
                    ...
                    <div class="flex items-center justify-between border-b border-emerald-800/60 pb-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="text-[10px] uppercase tracking-widest text-gold-400 font-bold">Manhaj Pembelajaran</div>
                                <div class="text-sm font-bold text-white">4 Tahapan ATFALAH</div>
                            </div>
                        </div>
                        <span class="text-[10px] px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-300 font-semibold border border-emerald-500/30">Mutawatir</span>
                    </div>

                    <div class="space-y-3.5 relative z-10">
                        <!-- Step 1 -->
                        <div class="flex items-start gap-3.5 p-3.5 rounded-2xl bg-emerald-900/30 border border-emerald-700/30 hover:border-gold-500/40 transition-colors">
                            <span class="w-7 h-7 rounded-xl bg-emerald-600/80 text-gold-300 text-xs font-bold flex items-center justify-center flex-shrink-0 border border-gold-500/20">١</span>
                            <div>
                                <h4 class="text-xs font-bold text-gold-300 tracking-wide flex items-center gap-1.5">
                                    <span>READ — Qira'ah Dasar</span>
                                </h4>
                                <p class="text-[11px] text-emerald-100/80 mt-0.5">Mengenal huruf hijaiyah, harakat, sukun, tasydid hingga membaca kata mandiri.</p>
                            </div>
                        </div>

                        <!-- Step 2 -->
                        <div class="flex items-start gap-3.5 p-3.5 rounded-2xl bg-emerald-900/30 border border-emerald-700/30 hover:border-gold-500/40 transition-colors">
                            <span class="w-7 h-7 rounded-xl bg-teal-600/80 text-gold-300 text-xs font-bold flex items-center justify-center flex-shrink-0 border border-gold-500/20">٢</span>
                            <div>
                                <h4 class="text-xs font-bold text-gold-300 tracking-wide flex items-center gap-1.5">
                                    <span>IMPROVE — Tahsin & Tajwid</span>
                                </h4>
                                <p class="text-[11px] text-emerald-100/80 mt-0.5">Menyempurnakan 5 tempat makhraj huruf, sifatul huruf, dan hukum tartil mutawatir.</p>
                            </div>
                        </div>

                        <!-- Step 3 -->
                        <div class="flex items-start gap-3.5 p-3.5 rounded-2xl bg-emerald-900/30 border border-emerald-700/30 hover:border-gold-500/40 transition-colors">
                            <span class="w-7 h-7 rounded-xl bg-indigo-600/80 text-gold-300 text-xs font-bold flex items-center justify-center flex-shrink-0 border border-gold-500/20">٣</span>
                            <div>
                                <h4 class="text-xs font-bold text-gold-300 tracking-wide flex items-center gap-1.5">
                                    <span>UNDERSTAND — Tadabbur Ayat</span>
                                </h4>
                                <p class="text-[11px] text-emerald-100/80 mt-0.5">Menyelami mufradat (kosakata kunci), asbabun nuzul, dan hikmah pesan surah.</p>
                            </div>
                        </div>

                        <!-- Step 4 -->
                        <div class="flex items-start gap-3.5 p-3.5 rounded-2xl bg-emerald-900/30 border border-emerald-700/30 hover:border-gold-500/40 transition-colors">
                            <span class="w-7 h-7 rounded-xl bg-amber-600/80 text-gold-300 text-xs font-bold flex items-center justify-center flex-shrink-0 border border-gold-500/20">٤</span>
                            <div>
                                <h4 class="text-xs font-bold text-gold-300 tracking-wide flex items-center gap-1.5">
                                    <span>LIVE — 'Amal & Fardhu 'Ain</span>
                                </h4>
                                <p class="text-[11px] text-emerald-100/80 mt-0.5">Mempraktikkan adab Qur'ani, fiqh thaharah & shalat, serta akhlaqul karimah.</p>
                            </div>
                        </div>
                    </div>

                    <div class="pt-2 text-center">
                        <a href="{{ route('register') }}" class="block w-full py-3.5 rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-700 hover:from-emerald-500 hover:to-teal-600 text-white font-bold text-xs shadow-lg transition-all border border-emerald-400/30">
...
<!-- 4 Core Programs Section with Islamic Embellishments -->
<section class="py-24 bg-islamic-subtle relative">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            @foreach($programs as $program)
                <div class="bg-white rounded-3xl p-7 border-2 border-emerald-900/10 shadow-lg shadow-emerald-900/5 hover:border-gold-500/50 hover:shadow-xl hover:-translate-y-1.5 transition-all flex flex-col justify-between group islamic-card">
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            <div class="w-13 h-13 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-800 flex items-center justify-center p-3 group-hover:bg-emerald-800 group-hover:text-gold-300 transition-colors shadow-sm">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl font-extrabold text-slate-900 mt-1 font-serif">{{ $program->name }}</h3>
                        </div>
                        ...
                        <div class="pt-3 border-t border-slate-100">
                            <div class="text-[11px] font-bold text-emerald-900 mb-2 flex items-center gap-1.5">
                                <span class="text-gold-500">✦</span> Modul Silabus ({{ $program->curriculumItems->count() }} Topik):
                            </div>
                    ...
                    <div class="pt-6 mt-6 border-t border-slate-100">
                        <a href="{{ route('programs.detail', $program->slug) }}" class="block w-full py-2.5 text-center text-xs font-bold rounded-xl bg-emerald-50 text-emerald-900 group-hover:bg-emerald-800 group-hover:text-gold-300 transition-all border border-emerald-200">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div class="lg:col-span-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
                    <div class="p-4 rounded-2xl bg-emerald-50/50 border border-emerald-100 flex items-start gap-3.5">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            @foreach($teachers as $teacher)
                <div class="bg-white rounded-3xl p-6 sm:p-8 border-2 border-emerald-900/10 flex flex-col sm:flex-row items-center sm:items-start gap-6 shadow-sm hover:border-gold-500/40 transition-colors islamic-card">
...
<section class="py-20 bg-gradient-to-r from-emerald-950 via-primary-900 to-slate-950 text-white relative overflow-hidden border-t-4 border-gold-500/80">
    <div class="max-w-5xl mx-auto px-4 text-center space-y-6 relative z-10">
        ...
        <div class="pt-2">
            <a href="{{ route('assessment') }}" class="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-gradient-to-r from-gold-400 to-amber-500 hover:from-gold-300 hover:to-amber-400 text-slate-950 font-extrabold text-sm shadow-xl shadow-amber-950/50 transition-all hover:scale-105 border border-gold-300/50">
