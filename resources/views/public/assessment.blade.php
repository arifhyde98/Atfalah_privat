...
@section('content')
<div class="bg-gradient-to-b from-primary-900 to-slate-900 text-white py-16">
    <div class="max-w-4xl mx-auto px-4 text-center space-y-3">
        <span class="text-xs font-bold tracking-widest text-gold-400 uppercase">Self-Evaluation & Placement</span>
        <h1 class="text-3xl sm:text-4xl font-extrabold tracking-tight">Evaluasi Mandiri & Rekomendasi Program</h1>
