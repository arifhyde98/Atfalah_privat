...
<div class="py-12 bg-slate-50 min-h-screen" x-data="assessmentWizard()">
    <div class="max-w-3xl mx-auto px-4">
        ...
        <div x-show="step === 1" class="bg-white rounded-3xl border border-slate-200 p-8 sm:p-10 shadow-sm space-y-8">
            <div class="border-b border-slate-100 pb-4">
                ...
                <div class="mt-4 space-y-2">
                    <label class="flex items-center gap-3 p-3.5 rounded-2xl border border-slate-200 hover:border-primary-600 hover:bg-rose-50/50 cursor-pointer transition-all">
            ...
            <div class="pt-4">
                <button type="button" @click="calculateResult()" class="w-full py-4 rounded-2xl bg-rose-700 hover:bg-rose-800 text-white font-bold text-sm shadow-lg shadow-primary-700/25 transition-all flex items-center justify-center gap-2">
        ...
        <div x-show="step === 2" x-transition class="bg-white rounded-3xl border border-primary-200 p-8 sm:p-10 shadow-xl space-y-6 text-center">
            <div class="w-16 h-16 rounded-3xl bg-rose-100 text-emerald-700 flex items-center justify-center mx-auto">
                <i data-lucide="check-circle" class="w-8 h-8"></i>
            </div>
            <div>
                <span class="text-xs font-bold tracking-wider text-emerald-700 uppercase bg-rose-100 px-3 py-1 rounded-full">Rekomendasi Terbaik Untuk Anda</span>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4">
                <a :href="'{{ url('/register') }}?program=' + recommendation.slug" class="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-rose-700 hover:bg-rose-800 text-white font-bold text-xs shadow transition-all">
