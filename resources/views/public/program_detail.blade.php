...
<div class="bg-islamic-pattern text-white py-20 border-b-4 border-gold-500/80 relative">
    <div class="max-w-5xl mx-auto px-4 text-center space-y-4 relative z-10">
        ...
        <span class="text-xs font-bold tracking-widest text-gold-400 uppercase bg-rose-950/80 px-3.5 py-1 rounded-full border border-gold-500/30">
        ...
        <div class="pt-4 flex flex-wrap items-center justify-center gap-4">
            ...
            <a href="{{ route('assessment') }}" class="px-6 py-3.5 rounded-xl bg-rose-950/60 hover:bg-rose-900 text-white font-semibold text-xs border border-emerald-500/30 transition-all">
    ...
    <div class="max-w-5xl mx-auto px-4 space-y-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-3">
                <div class="w-10 h-10 rounded-xl bg-rose-100 text-emerald-700 flex items-center justify-center">
        ...
        <div class="bg-white p-8 sm:p-10 rounded-3xl border border-slate-200 shadow-sm space-y-6">
            <div class="flex items-center justify-between border-b border-slate-100 pb-4">
                ...
                <span class="text-xs font-bold text-primary-700 bg-rose-50 px-3 py-1 rounded-full border border-primary-200">
            ...
            <div class="space-y-4">
                @foreach($program->curriculumItems as $item)
                    <div class="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 flex items-start gap-4">
                        <span class="w-8 h-8 rounded-xl bg-rose-700 text-white font-bold text-xs flex items-center justify-center flex-shrink-0 shadow-sm">
                            {{ $item->sequence }}
                        </span>
        ...
        <div class="bg-slate-900 text-white rounded-3xl p-8 text-center space-y-4">
            ...
            <div class="pt-2">
                <a href="{{ route('register', ['program' => $program->slug]) }}" class="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-rose-600 hover:bg-rose-500 text-white font-bold text-xs shadow-lg transition-colors">
